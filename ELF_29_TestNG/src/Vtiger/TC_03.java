...
public class TC_03 {
	...
	public static void main(String[] args) {
		...
		String expectedCheckBoxStatus = "yes ";
		WebElement activeCheckBox = driver.findElement(By.xpath("//span[@id='dtlview_Product Active']"));
		String actualCheckBoxStatus = activeCheckBox.getText();
		assertEquals(actualCheckBoxStatus, expectedCheckBoxStatus, "Check box is not Active");
