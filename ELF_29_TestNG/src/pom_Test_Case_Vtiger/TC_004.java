...
public class TC_004 extends VTiger_BaseTest{

	@Test
	public void createProductWithoutActiveCheckBox() {
		...
		assertEquals(productListPage.getVerifyCheckBox().getText(),checkBoxStatus , "Check box in Active");
	}
